...
export default function AdminDashboard() {
	...
	const modules = [
		...
		},
		{
			name: "Manage Events",
			description:
				"Schedule upcoming events, manage details, and track registration links.",
		...
		},
		{
			...
			description:
				"Edit contact emails, phone number, address, and map location.",
		...
		},
		{
			...
			description:
				"Update the About page headline, mission, and vision content.",
	...
	return (
		<div>
			...
			<p className="text-project-gray-500 mb-8 max-w-2xl">
				Welcome to the Iranian Jurists CMS. Select a module below to start
