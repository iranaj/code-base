...
if (!userId) {
  ...
  console.log('You can find your User ID in the Clerk Dashboard or by checking your profile.');
  process.exit(1);
}
...
async function run() {
  try {
    ...
    console.log('You may need to sign out and sign back in for changes to propagate to client sessions.');
  } catch (err) {
