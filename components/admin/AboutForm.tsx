...
export default function AboutForm() {
	...
	return (
		<form
			...
			className="space-y-10 max-w-5xl bg-white p-8 rounded-xl border border-project-gray-200 shadow-sm"
		>
			<div className="space-y-4">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div>
						<label
							htmlFor="about-intro-1-en"
							className="block text-sm font-medium text-project-gray-700 mb-1"
						>
							Intro Paragraph 1 (English)
						</label>
						<textarea
							id="about-intro-1-en"
							rows={4}
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div>
						<label
							htmlFor="about-intro-2-en"
							className="block text-sm font-medium text-project-gray-700 mb-1"
						>
							Intro Paragraph 2 (English)
						</label>
						<textarea
							id="about-intro-2-en"
							rows={4}
			...
			<div className="space-y-4">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div>
						<label
							htmlFor="about-mission-title-en"
							className="block text-sm font-medium text-project-gray-700 mb-1"
						>
						...
						<input
							...
							onChange={(e) =>
								updateField(["mission", "title", "en"], e.target.value)
							}
							className="w-full px-4 py-2 border border-project-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500"
						/>
					</div>
					<div dir="rtl">
						<label
							htmlFor="about-mission-title-fa"
							className="block text-sm font-medium text-project-gray-700 mb-1"
						>
							عنوان مأموریت (فارسی)
						</label>
						<input
							id="about-mission-title-fa"
							type="text"
							value={formData.mission.title.fa}
							onChange={(e) =>
								updateField(["mission", "title", "fa"], e.target.value)
							}
							className="w-full px-4 py-2 border border-project-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 font-bodyFa"
						/>
					</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div>
						<label
							htmlFor="about-mission-p1-en"
							className="block text-sm font-medium text-project-gray-700 mb-1"
						>
							Mission Paragraph 1 (English)
						</label>
						<textarea
							id="about-mission-p1-en"
							rows={4}
							value={formData.mission.p1.en}
							onChange={(e) =>
								updateField(["mission", "p1", "en"], e.target.value)
							}
							className="w-full px-4 py-2 border border-project-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500"
						/>
					</div>
					<div dir="rtl">
						<label
							htmlFor="about-mission-p1-fa"
							className="block text-sm font-medium text-project-gray-700 mb-1"
						>
							پاراگراف ۱ مأموریت (فارسی)
						</label>
						<textarea
							id="about-mission-p1-fa"
							rows={4}
							value={formData.mission.p1.fa}
							onChange={(e) =>
								updateField(["mission", "p1", "fa"], e.target.value)
							}
							className="w-full px-4 py-2 border border-project-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 font-bodyFa"
						/>
					</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div>
						<label
							htmlFor="about-mission-p2-en"
							className="block text-sm font-medium text-project-gray-700 mb-1"
						>
							Mission Paragraph 2 (English)
						</label>
						<textarea
							id="about-mission-p2-en"
							rows={4}
							value={formData.mission.p2.en}
							onChange={(e) =>
								updateField(["mission", "p2", "en"], e.target.value)
							}
							className="w-full px-4 py-2 border border-project-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500"
						/>
					</div>
					<div dir="rtl">
						<label
							htmlFor="about-mission-p2-fa"
							className="block text-sm font-medium text-project-gray-700 mb-1"
						>
							پاراگراف ۲ مأموریت (فارسی)
						</label>
						<textarea
							id="about-mission-p2-fa"
							rows={4}
							value={formData.mission.p2.fa}
							onChange={(e) =>
								updateField(["mission", "p2", "fa"], e.target.value)
							}
							className="w-full px-4 py-2 border border-project-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 font-bodyFa"
						/>
					</div>
				...
				<div className="space-y-3">
					<div className="flex items-center justify-between">
						<h3 className="text-sm font-semibold text-project-gray-700">
							Mission Bullets
						</h3>
						<button
							type="button"
					...
					{formData.mission.bullets.map((bullet, index) => (
						<div
							key={`${bullet.en}-${bullet.fa}`}
							className="grid grid-cols-1 md:grid-cols-2 gap-6 border border-project-gray-100 rounded-lg p-4"
						>
							<div>
								<label
									htmlFor={`mission-bullet-en-${index}`}
									className="block text-xs font-medium text-project-gray-600 mb-1"
								>
									Bullet {index + 1} (English)
								</label>
								<input
									id={`mission-bullet-en-${index}`}
									type="text"
									value={bullet.en}
									onChange={(e) =>
										updateField(
											["mission", "bullets", index, "en"],
											e.target.value,
										)
									}
									className="w-full px-4 py-2 border border-project-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500"
							...
							<div dir="rtl">
								<label
									htmlFor={`mission-bullet-fa-${index}`}
									className="block text-xs font-medium text-project-gray-600 mb-1"
								>
									گزینه {index + 1} (فارسی)
								</label>
								<input
									id={`mission-bullet-fa-${index}`}
									type="text"
									value={bullet.fa}
									onChange={(e) =>
										updateField(
											["mission", "bullets", index, "fa"],
											e.target.value,
										)
									}
									className="w-full px-4 py-2 border border-project-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 font-bodyFa"
			...
			<div className="space-y-4">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div>
						...
						<input
							...
							onChange={(e) =>
								updateField(["vision", "title", "en"], e.target.value)
							}
							className="w-full px-4 py-2 border border-project-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500"
						/>
					</div>
					<div dir="rtl">
						<label
							htmlFor="about-vision-title-fa"
							className="block text-sm font-medium text-project-gray-700 mb-1"
						>
							عنوان چشم‌انداز (فارسی)
						</label>
						<input
							id="about-vision-title-fa"
							type="text"
							value={formData.vision.title.fa}
							onChange={(e) =>
								updateField(["vision", "title", "fa"], e.target.value)
							}
							className="w-full px-4 py-2 border border-project-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 font-bodyFa"
						/>
					</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div>
						<label
							htmlFor="about-vision-p1-en"
							className="block text-sm font-medium text-project-gray-700 mb-1"
						>
							Vision Paragraph (English)
						</label>
						<textarea
							id="about-vision-p1-en"
							rows={4}
							value={formData.vision.p1.en}
							onChange={(e) =>
								updateField(["vision", "p1", "en"], e.target.value)
							}
							className="w-full px-4 py-2 border border-project-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500"
						/>
					</div>
					<div dir="rtl">
						<label
							htmlFor="about-vision-p1-fa"
							className="block text-sm font-medium text-project-gray-700 mb-1"
						>
							پاراگراف چشم‌انداز (فارسی)
						</label>
						<textarea
							id="about-vision-p1-fa"
							rows={4}
							value={formData.vision.p1.fa}
							onChange={(e) =>
								updateField(["vision", "p1", "fa"], e.target.value)
							}
							className="w-full px-4 py-2 border border-project-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 font-bodyFa"
						/>
					</div>
