...
export default function AdvocacyForm({ initialData, isEditing = false }: AdvocacyFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl bg-white p-8 rounded-xl border border-project-gray-200 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">Slug</label>
        ...
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">Published Date</label>
          <input
            type="date"
            name="publishedAt"
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">Author</label>
          <input
            type="text"
            name="author"
      ...
      <div className="space-y-6">
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">Content (English)</label>
          <textarea
            name="contentEn"
        ...
        <div dir="rtl">
          <label className="block text-sm font-medium text-project-gray-700 mb-1">محتوا (فارسی)</label>
          <textarea
            name="contentFa"
