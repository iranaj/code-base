  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl bg-white p-8 rounded-xl border border-project-gray-200 shadow-sm">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">Media Email</label>
          <input
            type="email"
            name="mediaEmail"
        ...
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">General Email</label>
          <input
            type="email"
            name="generalEmail"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">General Phone</label>
          <input
            type="text"
            name="generalPhone"
        ...
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">Map Link</label>
          <input
            type="url"
            name="mapLink"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">Address Line 1</label>
          <input
            type="text"
            name="addressLine1"
        ...
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">Address Line 2</label>
          <input
            type="text"
            name="addressLine2"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">City</label>
          <input
            type="text"
            name="city"
            value={formData.city}
        ...
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">State</label>
          <input
            type="text"
            name="state"
        ...
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">Postal Code</label>
          <input
            type="text"
            name="postalCode"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">Country</label>
          <input
            type="text"
            name="country"
        ...
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">Map Zoom</label>
          <input
            type="number"
            name="mapZoom"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">Map Latitude</label>
          <input
            type="number"
            name="mapLatitude"
        ...
        <div>
          <label className="block text-sm font-medium text-project-gray-700 mb-1">Map Longitude</label>
          <input
            type="number"
            name="mapLongitude"
