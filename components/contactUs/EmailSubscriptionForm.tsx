  ...
  return (
    <form className="col-span-2 relative" onSubmit={handleEmailSubmit}>
      <input
        ...
        className="w-full h-14 border-2 border-gray-300 rounded-lg bg-gray-200 px-4 accent-1 focus:outline-none focus:ring-2 focus:ring-secondary-500 focus:border-transparent placeholder:text-gray-300 placeholder:text-left rtl:text-left "
        required
        disabled={isLoading}
      />
      {isLoading ? (
